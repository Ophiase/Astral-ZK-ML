...
#[starknet::interface]
pub trait IFullyDecentralizedContract<TContractState> {
    fn predict(ref self: TContractState, inputs: Matrix, for_storage: bool) -> Matrix;
}

#[starknet::contract]
pub mod FullyDecentralizedContract {
    ...
    #[abi(embed_v0)]
    impl ContractImpl of super::IFullyDecentralizedContract<ContractState> {
